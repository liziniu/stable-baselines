...
register(
    id='AntGoal-v2',
    entry_point='gym.envs.robotics:AntGoalEnv',
    max_episode_steps=50,
    reward_threshold=50,
)
...
for reward_type in ['sparse', 'dense']:
    ...
    # ====================
    register(
        id='FetchReach{}-random-v2'.format(suffix),
        entry_point='gym.envs.robotics:FetchReachEnv',
        kwargs={'reward_type': reward_type, 'target_range': 0.15},
        max_episode_steps=50,
    )
    ...
    register(
        ...
        entry_point='gym.envs.robotics:FetchReachEnv',
        kwargs={'reward_type': reward_type, 'target_range': [0.14, 0.15]},
        max_episode_steps=50,
    )

    register(
        id='FetchReach{}-random-v3'.format(suffix),
        entry_point='gym.envs.robotics:FetchReachEnv',
        kwargs={'reward_type': reward_type, 'target_range': 0.17},
        max_episode_steps=50,
    )

    register(
        id='FetchReach{}-v3'.format(suffix),
        entry_point='gym.envs.robotics:FetchReachEnv',
        kwargs={'reward_type': reward_type, 'target_range': [0.16, 0.17]},
        max_episode_steps=50,
    )

    register(
        id='FetchReach{}-random-v4'.format(suffix),
        entry_point='gym.envs.robotics:FetchReachEnv',
        kwargs={'reward_type': reward_type, 'target_range': 0.19},
        max_episode_steps=50,
    )

    register(
        id='FetchReach{}-v4'.format(suffix),
        entry_point='gym.envs.robotics:FetchReachEnv',
        kwargs={'reward_type': reward_type, 'target_range': [0.18, 0.19]},
        max_episode_steps=50,
    )
    # ====================
