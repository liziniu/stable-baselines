...
class EnvRegistry(object):
    ...
    def make(self, id, **kwargs):
        ...
        if hasattr(env, "_reset") and hasattr(env, "_step") and not getattr(env, "_gym_disable_underscore_compat", False):
            ...
            print("gym: path_deprecated_methods")
...
def patch_deprecated_methods(env):
    ...
    if warn_once:
        ...
        print("Environment '%s' has deprecated methods '_step' and '_reset' rather than 'step' and 'reset'. Compatibility code invoked. Set _gym_disable_underscore_compat = True to disable this behavior." % str(type(env)))
        warn_once = False
